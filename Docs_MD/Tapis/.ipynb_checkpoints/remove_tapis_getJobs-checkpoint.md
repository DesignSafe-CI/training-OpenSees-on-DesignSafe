<!-- # Tapis: Retrieving Jobs
***Retrieving Job Metadata and Outputs***

Tapis allows you to retrieve both **metadata and actual data** for all your jobs — whether they were submitted directly through Tapis or via any DesignSafe application (such as the OpenSeesMP and OpenSeesSP web portal apps).
