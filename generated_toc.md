...
- [OpenSees-Tcl & OpenSeesPy](Docs_MD/DesignSafe/OpenSees_Interpreters.md)
- [OpenSees_Applications](Docs_MD/DesignSafe/OpenSees_Applications.md)
- [Interpreters & Workflows](Docs_MD/DesignSafe/OpenSees_Workflows.md)
...
- [paths_Tapis](Jupyter_Notebooks/paths_Tapis.ipynb)
...
- [app.json vs profile.json](Docs_MD/Tapis/tapis_appsDev_Jsons.md)
- [App-Definition Files](Docs_MD/Tapis/tapis_app_def_files.md)
...
- [tapis_appsDev_CustomApp_Agnostic_Run](Jupyter_Notebooks/tapis_appsDev_CustomApp_Agnostic_Run.ipynb)
      <sub>📂 <a href='https://jupyter.designsafe-ci.org/hub/user-redirect/notebooks/CommunityData/OpenSees/TrainingMaterial/training-OpenSees-on-DesignSafe/Jupyter_Notebooks/tapis_appsDev_CustomApp_Agnostic_Run.ipynb' target='_blank'>Open in JupyterHub</a></sub>
