...
#     - NEW: If you press Enter on the password prompt (blank), it restarts the
#       login prompts so you can re-enter the username.
...
#         Blank password restarts and re-prompts username.
#         """
#         while True:
